...
export default {
	...
	setup(props, context) {
		...
		context.expose({clear: data.clear, resolveOptions: data.resolveOptions});
		return data;
	},
};
</script>
		...
		>
			...
			<template v-if="mode == 'tags'">
				...
				>
					...
					>
						<span
							:class="[classList.tag, option.disabled ? classList.tagDisabled : null]"
							tabindex="-1"
					...
					<div
						:class="classList.tagsSearchWrapper"
						ref="tags"
					>
