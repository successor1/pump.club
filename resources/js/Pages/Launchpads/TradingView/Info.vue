...
<template>
	<div class="text-white rounded-lg">
		...
		<div class="flex items-center gap-3 p-2 my-4 bg-gray-850">
			...
			<BaseButton class="ml-auto" secondary outlined>
				663 Holders
			</BaseButton>
		</div>
		...
		<Progress
			...
			<TradingStats v-else :stats="$page.props.report" />
		</Progress>
		...
		<!-- Alerts Button -->
		<div
			class="grid gap-3 mt-5 rounded border border-gray-750 bg-gray-850 pt-4">
			<div class="px-4">
				<a
