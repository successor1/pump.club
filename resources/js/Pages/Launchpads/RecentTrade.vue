...
<template>
	<Link
		...
		<div
			class="bg-gray-800 border border-gray-700 hover:bg-gray-750 p-4 rounded">
			<div
				class="flex items-center justify-between rounded transition-colors duration-200">
				<span
				...
				<div class="flex items-center gap-2">
					...
					<div
						class="flex items-center text-sm font-semibold text-[#f0b90b]">
						{{ parseFloat(trade.amount).toFixed(4) * 1 }} ETH
					</div>
					<div
						class="flex items-center text-sm font-semibold text-[#f0b90b]">
			...
			<div class="flex mt-1 items-center justify-between">
				...
				<div
					class="text-xs px-1.5 py-0.5 text-gray-400 border rounded-full border-gray-600">
					{{ trade.date }}
				</div>
			</div>
		</div>
